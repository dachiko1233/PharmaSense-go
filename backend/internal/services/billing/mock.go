...
func (m *MockBillingService) CreateCheckoutSession(ctx context.Context, customerID, priceID, pharmacyID string) (string, error) {
	slog.Info("[MOCK STRIPE] checkout session created",
		"customer_id", customerID,
		"price_id", priceID,
		"pharmacy_id", pharmacyID,
	)
	return m.frontendOrigin + "/mock-stripe/checkout?plan=" + priceID, nil
}
...
type BillingProvider interface {
	CreateCheckoutSession(ctx context.Context, customerID, priceID, pharmacyID string) (string, error)
